...
Most of these come down to network reality or how juejin-cli serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

juejin-cli rate-limits like any public site. juejin already paces
...
Where a surface is gated, juejin reads a cookie or token you supply
...
`juejin`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what juejin actually did
